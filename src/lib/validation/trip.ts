...
export const tripSchema = z.object({
  ...
  extra_loading_fare: z.coerce.number().min(0, "أجرة التحميل الإضافي يجب أن تكون رقماً موجباً"),
  overnight_fare: z.coerce.number().min(0, "أجرة المبيت/المرتجع يجب أن تكون رقماً موجباً"),
